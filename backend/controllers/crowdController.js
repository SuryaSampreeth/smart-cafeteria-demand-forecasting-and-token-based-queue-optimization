...
const getAdminCrowdAnalytics = async (req, res) => {
    try {
        ...
        // Calculate peak hours for all active slots
        ...
        res.json({
            ...
            alerts: {
                ...
                bySeverity: {
                    critical: totalAlerts.filter(a => a.severity === 'critical').length,
                    high: totalAlerts.filter(a => a.severity === 'high').length,
                    medium: totalAlerts.filter(a => a.severity === 'medium').length,
                    low: totalAlerts.filter(a => a.severity === 'low').length,
                },
            },
            trends: {
