 ...
 * 2. Booking List with Filter Tabs (All, Active, Completed).
 * 3. Actions for Active Bookings: Cancel or Modify.
 * 4. Status badges for easy identification of booking state.
 */
const ProfileScreen = () => {
    const { user } = useAuth();
