 ...
 */
const CrowdLevelIndicator = ({ level, occupancyRate, slotName, size = 'medium' }) => {

    // Mapping of crowd levels to specific UI styles (Color, Icon, Label)
    /*
     * This function maps the crowd level to UI properties.
     * Each level has a unique color, icon, label, and background.
     */
    ...
    /*
     * Size configurations allow this component
     * to be reused in different parts of the app.
     * Example:
     * - small: compact list views
     * - medium: normal cards
     * - large: main dashboard display
     */
    const sizeConfig = {
        small: {
            iconSize: 20,
    ...
    return (
        /*
         * Outer container of the indicator.
         * Background color changes based on crowd level.
         */
