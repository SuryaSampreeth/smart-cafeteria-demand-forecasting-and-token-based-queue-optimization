 ...
 */
const CrowdPatternChart = ({ historicalData, slotName, title = 'Crowd Pattern' }) => {
            ...
            <View style={styles.chartContainer}>
                <LineChart
                    ...
                    chartConfig={{
                        ...
                        color: (opacity = 1) => `rgba(94, 48, 35, ${opacity})`,
                        labelColor: (opacity = 1) => `rgba(94, 48, 35, ${opacity})`,
                        style: {
                            borderRadius: 16,
                        },
                        propsForDots: {
